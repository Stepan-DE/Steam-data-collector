...
Как уже было сказано эта работа была сделана по мотивам утреянного проекта и довольно забано наблюдать над тем как ты делаешь что то снова, но твои навыки стали намного лучше и теперь менее чемза неделю мне удалось сделать, то на что до этого уходили месяцы упорной работы.

В этом файле будут все существенные обновления и информация об актуальной версии моего проекта.

1. в 9 февраля была начата работа над востановлением проекта: реализован черновой вариант ETL процесса
2. в 10 февраля первая версия проекта (2.0) была опубликована, именно это послужило осной дальнейшего.

3. К 15 февраля в проекте реализован полноценный ETL-процесс.
...
Ознакомиться с проделанной работой можно запустив проект локально или посмотрев итоги в моих файлах:
- ER-диаграмма: `ER_diagram.png`
- Видео работы программы и интерфейс: `demo(2.1).mp4` или на VK видео перейдя по ссылке: `https://vkvideo.ru/video-235877670_456239021`
